...
plugins=(bazel tmux virtualenv macos fzf)
...
alias c8="cd ~/repo/niantic/reality"
alias cdc8="cd ~/repo/niantic/reality"
alias p8="cd ~/repo/prod8"
alias cdp8="cd ~/repo/prod8"
alias t8="cd ~/repo/tools8"
alias cdt8="cd ~/repo/tools8"
alias xrhome="cd ~/repo/niantic/reality/cloud/xrhome"
alias sd8="cd ~/repo/niantic/reality/cloud/aws/lambda/studio-deploy"
alias web8="cd ~/repo/web8"
alias reinstallg8="brew reinstall g8 --HEAD"
alias xsa="cd ~/repo/niantic/reality/cloud/xrreleases/server-admin"
alias cl="~/repo/niantic/scripts/eslint-diff.js \$(git merge-base HEAD master)"   
alias g8s="g8 status"
alias gst="g8 status"
alias g8c="g8 client"
alias gc="g8 client"
...
# Set HUBSPOT key for prod
export HUBSPOT_KEY="afcb427f-b469-434b-8b33-521aae624025"
